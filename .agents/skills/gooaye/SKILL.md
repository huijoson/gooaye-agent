...
本 Skill 封裝了《Gooaye 股癌》700 集（550+ 小時）的完整觀念資料庫與主委的投資決策思維體系。
...
### 輸出要求
- **機器轉錄來源**：EP694–EP700 為官方 SoundOn 音訊的本機 ASR，尚未人工校對。引用時註明此狀態；人名、股票代號、數字或精確措辭存疑時，依 `.work/asr-transcripts/EPxxxx.json` 的時間段核對原音，無法核對則標示不確定。
...
| 資源 | 路徑 | 說明 |
| :--- | :--- | :--- |
| **全集大綱總表** | `gooaye-youtube-notes/_index.md` | 700 集完整章節大綱、主題專題導航與關鍵字快速索引。 |
